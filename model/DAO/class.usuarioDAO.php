...
class usuarioDAO extends dataSource implements IUsuario {
  ...
  public function insert(\usuario $usuario) {
	$sql = 'INSERT INTO usuario (usu_alias, usu_contrasena, rol_id) VALUES (:alias, :contrasena, :rolId)';
	$params = array(
  ...
  public function search($alias, $contrasena) {
	$sql = 'SELECT usu_alias, usu_contrasena, rol_id FROM usuario WHERE usu_alias = :alias AND usu_contrasena = :contrasena';
	$params = array(
		':alias' => $alias,
  ...
  public function select() {
	$sql = 'SELECT usu_id, usu_alias, usu_contrasena, rol_id, usu_created_at FROM usuario WHERE usu_deleted_at IS NULL';
	return $this->query($sql);
  }

  public function selectById($id) {
	$sql = 'SELECT usu_alias, usu_contrasena, rol_id FROM usuario WHERE usu_id = :id';
	$params = array(
		':id' => $id
	);
	return $this->query($sql, $params);
